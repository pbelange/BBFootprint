...
# Saving data
coordinates.insert(0,'DQx_lr',DQx_lr)
coordinates.insert(1,'DQy_lr',DQy_lr)
coordinates.insert(2,'DQx_ho',DQx_ho)
coordinates.insert(3,'DQy_ho',DQy_ho)

coordinates.to_pickle(f"Results/Octupole_footprint.pkl")
...
plt.tight_layout()
plt.savefig('Results/Octupole_footprint.pdf',format='pdf')
